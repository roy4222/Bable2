...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        ...
        <div class="bg-[#1a242c] rounded-xl shadow-2xl border border-yellow-900/20 p-8">
            ...
            <?php if (isset($error)): ?>
                <div class="bg-red-900/20 border border-red-500/20 text-red-400 px-4 py-3 rounded-lg mb-6">
                    <?php echo $error; ?>
                </div>
            <?php endif; ?>

            <form onsubmit="event.preventDefault(); handleLogin(this.email.value, this.password.value);" class="space-y-6">
                <!-- 電子郵件輸入框 -->
                <div>
